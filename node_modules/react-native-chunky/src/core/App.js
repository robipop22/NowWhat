    ...
    if (section.layout === "tabs") {
      return TabNavigator(routes, {
        ...
        tabBarOptions: {
          ...
          showIcon: true,
          showLabel: true,
          activeTintColor: this.props.theme.navigationTintColor,
          inactiveTintColor: this.props.theme.navigationColor,
          indicatorStyle: { backgroundColor: this.props.theme.underLineColor, height: 3 },
          tabStyle: {
