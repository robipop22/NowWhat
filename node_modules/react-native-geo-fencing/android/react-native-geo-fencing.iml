...
<module external.linked.project.id=":react-native-geo-fencing" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-geo-fencing" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" exported="" name="com.google.android.gms:play-services-maps-8.4.0" level="project" />
    <orderEntry type="library" exported="" name="com.android.support:appcompat-v7-23.0.1" level="project" />
    <orderEntry type="library" exported="" name="com.google.android.gms:play-services-base-8.4.0" level="project" />
    ...
    <orderEntry type="library" exported="" name="com.google.maps.android:android-maps-utils-0.4" level="project" />
    <orderEntry type="library" exported="" name="com.facebook.react:react-native-0.19.1" level="project" />
